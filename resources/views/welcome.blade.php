...
<head>
    ...
    <title>Geolocation social website</title>
...
<body class="antialiased">
    <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100  dark:bg-gray-900 selection:bg-red-500 selection:text-white">
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div class="flex justify-center mt-16 px-0 text-gray-900 dark:text-white" style="font-size: 20px">geolocation social website</div>
            <div class="flex justify-center mt-2 px-0 text-gray-900 dark:text-white" style="font-size: 20px">register or login to continue!</div>
